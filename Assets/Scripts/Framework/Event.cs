...
namespace Framework
{
    ...
    public class TypeEventSystem : ITypeEventSystem
    {
        ...
        private Dictionary<Type, IRegistrations> _eventRegistrations= new Dictionary<Type, IRegistrations>();
        ...
        public void Send<T>(T e)
        {
            ...
            if (_eventRegistrations.TryGetValue(type,out IRegistrations eventRegistrations))
            {
